...
class Xoo_El_Core{
	...
	*/
	...
	public function show_outdated_template_notice(){
		...
		?>
		<div class="notice notice-success is-dismissible xoo-el-admin-notice">
		<p><?php printf( 'You have <a href="%1$s">outdated templates</a> in your theme which are no longer supported. Please fetch a new copy from the plugin folder.<br>Afterwards go to <a href="%1$s">Settings</a> & click on check again. Until then plugin will use the default templates', admin_url( 'admin.php?page=easy-login-woocommerce-settings' ) ); ?></p>
		</div>
		<?php
	}
